...
class SwinUnet(nn.Module):
    def __init__(self, config, img_size=224, num_classes=21843, zero_head=False, vis=False):
        ...
        if model_type == 'swin_ang':
            ...
            self.swin_unet = SwinTransformer(img_size=config.DATA.IMG_SIZE,
                                    radius_cuts=config.MODEL.SWIN.RADIUS_CUTS, 
                                    azimuth_cuts=config.MODEL.SWIN.AZIMUTH_CUTS,
                                    in_chans=config.MODEL.SWIN.IN_CHANS,
                                    num_classes=config.MODEL.NUM_CLASSES,
            ...
            self.swin_unet = SwinTransformerV2(img_size=config.DATA.IMG_SIZE,
            ...
            self.swin_unet = SwinMLP(img_size=config.DATA.IMG_SIZE,
